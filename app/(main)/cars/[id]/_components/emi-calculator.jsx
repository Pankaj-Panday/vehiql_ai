          ...
          {results && (
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 mt-4">
              <div className="text-center mb-4">
                <div className="text-sm font-inter text-gray-700 dark:text-gray-300">Monthly Payment</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg">
                  <div className="text-sm font-inter text-gray-700 dark:text-gray-300">Vehicle Price</div>
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg">
                  <div className="text-sm font-inter text-gray-700 dark:text-gray-300">Down Payment</div>
                  <div className="text-lg font-bold text-gray-900 dark:text-white mt-1">
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg">
                  <div className="text-sm font-inter text-gray-700 dark:text-gray-300">Loan Amount</div>
                  <div className="text-lg font-bold text-gray-900 dark:text-white mt-1">
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg">
                  <div className="text-sm font-inter text-gray-700 dark:text-gray-300">Total Interest</div>
                  <div className="text-lg font-bold text-gray-900 dark:text-white mt-1">
