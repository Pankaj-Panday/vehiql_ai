...
import { Camera, Loader2, UploadIcon, X } from "lucide-react";
...
export default function AddCarForm() {
  ...
  useEffect(() => {
    if (processImageResult?.success && uploadedAiImage) {
                  ...
                  {imagePreview ? (
                    ...
                    <div {...getAiRootProps()} className="cursor-pointer hover:bg-gray-50 transition">
                      ...
                      <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="text-sm text-gray-600">Drag & drop or click to upload a car image</p>
